...
from fh.models import Dosen, Staf, Mahasiswa
from fh.forms import FormDosen, FormStaf, FormMahasiswa
...
def tambah_dosenfh(request):
    if request.POST:
        ...
        if form.is_valid():
            ...
            return render(request, 'tambah-dosenfh.html', konteks)
    else: 
...
def tambah_staffh(request):
    if request.POST:
        ...
        if form1.is_valid():
            ...
            return render(request, 'tambah-staffh.html', konteks)
    else: 
...
def tambah_mahasiswafh(request):
    if request.POST:
        ...
        if form2.is_valid():
            ...
            return render(request, 'tambah-mahasiswafh.html', konteks)
    else: 
